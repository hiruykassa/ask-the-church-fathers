...
export const RIGHT_SECTIONS = [
  ...
  },
  {
    ...
    title: 'Apocrypha',
    entries: [
      { title: 'Gospel of Thomas',              query: 'Gospel of Thomas' },
      { title: 'Gospel of Peter',               query: 'Gospel of Peter' },
      { title: 'Protoevangelium of James',      query: 'Protoevangelium of James' },
      { title: 'Acts of Paul and Thecla',       query: 'Acts of Paul and Thecla' },
      { title: 'Apocalypse of Peter',           query: 'Apocalypse of Peter' },
